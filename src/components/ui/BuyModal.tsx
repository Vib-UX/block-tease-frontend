...
const BuyModal = ({
  txHash,
  progress,
  isOpen, icon, name, onClick, onClose, listingPrice
}: {
  progress: number;
  txHash: string;
  onClick: () => void;
              ...
              <DialogPanel style={{
                ...
                <div className=' flex justify-between'>
                  ...
                  <div className=' flex flex-col'>
                    ...
                    <span className='flex items-center justify-start'>{listingPrice}  <p className='flex gap-2 items-center text-white '>
                      &nbsp;
                      <svg
                        aria-label='USDC'
                        width='.4em'
