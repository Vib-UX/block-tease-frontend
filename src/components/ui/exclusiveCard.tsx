    ...
    <div className='flex flex-col items-end gap-3 p-1'>
      <div className='flex gap-10 justify-between'>
        <div className=' flex gap-5 justify-center'>
          <Image src={image} alt="logo" width={48} height={48} className='w-12 h-12 rounded-md' />
          ...
          <div className='flex gap-2 flex-col items-center justify-center'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <div className='flex gap-2 text-xs'>
                <span className='px-2 bg-slate-600 flex  items-center  rounded-md text-white'> <svg
                  aria-label='USDC'
                  width='1em'
                  height='1em'
                  viewBox='0 0 32 32'
                ...
                </svg>&nbsp;212.5</span><span className='px-2 bg-slate-600  rounded-md text-white'>0/40 left</span><span className='px-2 bg-slate-600  rounded-md text-white'>31</span><span className='px-2 bg-slate-600  rounded-md text-white'>1</span>
              </div>
      ...
      <div className='text-sm '>
        <span className='bg-fuchsia-500 rounded-lg px-2 py-1 text-white'>Buy</span>
